...
public class NodeService : EcsAppService, INodeService
{
    ...
    public async Task<ResponseDto> NodeCmdSeedAsync()
    {
        try
        {
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("12", EcsConsts.NodeType_DoorOpen, 10));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMToZeroPos, 1));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMToSafePos, 5));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_ReadCell, 4));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMOutPick, 2));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMOutPlace, 3));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMInPick, 7));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMInPlace, 8));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMMovePick, 11));
            await _nodeManager.AddNodeCmdAsync(new DispatchNodeCmd("13", EcsConsts.NodeType_LMMovePlace, 12));
