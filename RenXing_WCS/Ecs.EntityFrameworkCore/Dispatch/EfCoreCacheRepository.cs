...
{
    public class EfCoreCacheRepository : EfCoreRepository<EcsDbContext, DispatchCache, int>, ICacheRepository
    {
        public EfCoreCacheRepository(IDbContextProvider<EcsDbContext> dbContextProvider) : base(dbContextProvider)
        {
