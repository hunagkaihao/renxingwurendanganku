...
{
    public class EfCoreDahSpecsRepository : EfCoreRepository<EcsDbContext, DahSpecs, int>, IDahSpecsRepository
    {
        public EfCoreDahSpecsRepository(IDbContextProvider<EcsDbContext> dbContextProvider) : base(dbContextProvider)
        {
