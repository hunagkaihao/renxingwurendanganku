...
{
    public class EfCoreCellRepository : EfCoreRepository<EcsDbContext, DispatchCell, int>, ICellRepository
    {
        public EfCoreCellRepository(IDbContextProvider<EcsDbContext> dbContextProvider) : base(dbContextProvider)
        {
