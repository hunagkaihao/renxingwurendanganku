...
import {
  ...
  PagingCheckListInput,
  CheckDtoPagedResultDto,
...
export async function Executing(
    ...
    const request = new IdIntInput();
    request.id = id;
    await _checksServiceProxy.checkExecute(request);
    message.success(t('common.operationSuccess'));
    return true;
}
//取消盘点计划
export async function Delete(
  id:number
    ...
    const request = new IdIntInput();
    request.id = id;
  await _checksServiceProxy.delete(request);
  message.success(t('common.operationSuccess'));
}
//盘点结果处理账实一致
...
export async function LossConfirm(
  id:number
    ...
    var params = new IdIntInput()
    params.id = id
  await _checksServiceProxy.inventoryLossConfirm(params);
  message.success(t('common.operationSuccess'));
}
//盘点结果处理盘盈入库
export async function createSurplusIn(
  ...
  await _checksServiceProxy.createSurplusIn(boxRfid,cellName);
  message.success(t('common.operationSuccess'));
}
//盘点结果处理盘亏出库
export async function createLossOut(
  ...
  await _checksServiceProxy.createLossOut(boxRfid,cellName);
  message.success(t('common.operationSuccess'));
}
//盘点完成
export async function Complete(
  ...
  await _checksServiceProxy.checkComplete(params);
  message.success(t('common.operationSuccess'));
}
//批量创建cell
