export default {
  ...
  bookManagement_type: 'Type',
  bookManagement_name: 'Name',
  bookManagement_publishDate: 'PublishDate',
  bookManagement_price: 'Price',
  bookManagement_createTime: 'CreateTime',
  bookManagement_create_book: 'CreateBook',
  bookManagement_edit_book: 'EditBook',
};
