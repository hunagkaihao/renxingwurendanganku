...
{
    public class WcsDoor4Job : IHostedService, IDisposable
    {
        private JobHelper _jobHelper;
        private ILog _logger;
        private IRedisClient _redisClient;
        public WcsDoor4Job(JobHelper jobHelper, ILog logger, IRedisClient redisClient)
        {
        ...
        private const string CmdTagName = "Door4_Cmd";
        private const string ResponseTagName = "Door4_Response";
        private const string RedisKey = "WcsDoor4Job";
        private const string LastCmdTagValField = "LastDoor4Cmd";
