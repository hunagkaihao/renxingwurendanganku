...
{
    public class WcsDoor7Job : IHostedService, IDisposable
    {
        private JobHelper _jobHelper;
        private ILog _logger;
        private IRedisClient _redisClient;
        public WcsDoor7Job(JobHelper jobHelper, ILog logger, IRedisClient redisClient)
        {
        ...
        private const string CmdTagName = "Door7_Cmd";
        private const string ResponseTagName = "Door7_Response";
        private const string RedisKey = "WcsDoor7Job";
        private const string LastCmdTagValField = "LastDoor7Cmd";
