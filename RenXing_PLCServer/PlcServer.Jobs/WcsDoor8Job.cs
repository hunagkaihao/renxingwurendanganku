...
{
    public class WcsDoor8Job : IHostedService, IDisposable
    {
        private JobHelper _jobHelper;
        private ILog _logger;
        private IRedisClient _redisClient;
        public WcsDoor8Job(JobHelper jobHelper, ILog logger, IRedisClient redisClient)
        {
        ...
        private const string CmdTagName = "Door8_Cmd";
        private const string ResponseTagName = "Door8_Response";
        private const string RedisKey = "WcsDoor8Job";
        private const string LastCmdTagValField = "LastDoor8Cmd";
