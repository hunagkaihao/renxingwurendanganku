...
{
    public class WcsDoor3Job : IHostedService, IDisposable
    {
        private JobHelper _jobHelper;
        private ILog _logger;
        private IRedisClient _redisClient;
        public WcsDoor3Job(JobHelper jobHelper, ILog logger, IRedisClient redisClient)
        {
        ...
        private const string CmdTagName = "Door3_Cmd";
        private const string ResponseTagName = "Door3_Response";
        private const string RedisKey = "WcsDoor3Job";
        private const string LastCmdTagValField = "LastDoor3Cmd";
