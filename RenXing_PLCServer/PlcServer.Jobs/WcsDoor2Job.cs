...
{
    public class WcsDoor2Job : IHostedService, IDisposable
    {
        private JobHelper _jobHelper;
        private ILog _logger;
        private IRedisClient _redisClient;
        public WcsDoor2Job(JobHelper jobHelper, ILog logger, IRedisClient redisClient)
        {
        ...
        private const string CmdTagName = "Door2_Cmd";
        private const string ResponseTagName = "Door2_Response";
        private const string RedisKey = "WcsDoor2Job";
        private const string LastCmdTagValField = "LastDoor2Cmd";
