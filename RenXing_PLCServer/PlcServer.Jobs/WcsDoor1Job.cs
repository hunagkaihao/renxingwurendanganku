...
{
    public class WcsDoor1Job : IHostedService, IDisposable
    {
        private JobHelper _jobHelper;
        private ILog _logger;
        private IRedisClient _redisClient;
        public WcsDoor1Job(JobHelper jobHelper, ILog logger, IRedisClient redisClient)
        {
        ...
        private const string CmdTagName = "Door1_Cmd";
        private const string ResponseTagName = "Door1_Response";
        private const string RedisKey = "WcsDoor1Job";
        private const string LastCmdTagValField = "LastDoor1Cmd";
