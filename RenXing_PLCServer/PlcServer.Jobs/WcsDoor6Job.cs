...
{
    public class WcsDoor6Job : IHostedService, IDisposable
    {
        private JobHelper _jobHelper;
        private ILog _logger;
        private IRedisClient _redisClient;
        public WcsDoor6Job(JobHelper jobHelper, ILog logger, IRedisClient redisClient)
        {
        ...
        private const string CmdTagName = "Door6_Cmd";
        private const string ResponseTagName = "Door6_Response";
        private const string RedisKey = "WcsDoor6Job";
        private const string LastCmdTagValField = "LastDoor6Cmd";
