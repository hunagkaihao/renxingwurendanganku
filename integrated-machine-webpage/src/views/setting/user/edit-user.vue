                ...
                <Tabs value="detail">
                    <TabPane :label="L('UserDetails')" name="detail">
                        <FormItem :label="L('UserName')" prop="userName">
                            <Input v-model="user.userName" :maxlength="32" :minlength="2"> <Icon type="ios-keypad" slot="suffix"  @click="openKeyboard" /></Input>
                        </FormItem>
                        <FormItem :label="L('Name')" prop="name">
                            <Input v-model="user.name" :maxlength="32"> <Icon type="ios-keypad" slot="suffix"  @click="openKeyboard" /></Input>
                        </FormItem>
