            ...
            <Form ref="archiveForm"  label-position="top" :rules="archiveRule" :model="archive">
                ...
                <FormItem :label="L('GoodsUnits')" prop="goodsUnits">
                 ...
                 <FormItem :label="L('RfidId')" prop="rfidId">
                    <Input v-model="archive.rfidId" :maxlength="32"></Input>
                </FormItem>
...
<script lang="ts">
    ...
    @Component
    export default class EditArchive extends AbpBase{
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                this.archive=Util.extend(true,{},this.$store.state.archive.editArchive);
            }
        }
        archiveRule={
