               ...
               <Row :gutter="24">
                       <Col span="6">
                            <!-- <FormItem :label="L('Keyword')+':'" style="width:100%"> -->
                                <Input v-model="pagerequest.year" :placeholder="L('年度')"  clearable required autofocus  @keyup.enter.native="getpage"><Icon type="ios-keypad" slot="suffix"  @click="openKeyboard" /></Input>                               
                            <!-- </FormItem> -->
                        </Col>
                        <Col span="13">
                            <!-- <FormItem :label="L('Keyword')+':'" style="width:100%"> -->                        
                                <Input v-model="pagerequest.pzh" :placeholder="L('凭证号')"  clearable required autofocus  @keyup.enter.native="getpage"><Icon type="ios-keypad" slot="suffix"  @click="openKeyboard" /></Input>
                            <!-- </FormItem> -->
                        </Col>
                         <Col span="5">
    ...
    export default class SearchArchive extends AbpBase{
        ...
        stocktask:Stocktask=new Stocktask();
         columns2=[
            ...
            title:this.L('年度'),
            align: 'center',
            key:'goodsConstProperty1'
        },
         {
            title:this.L('凭证起止号'),
            align: 'center',
            key:'goodsConstProperty5'
        },{
            title:this.L('案卷标签'),
            width: 95,
            align: 'center',
            ...
            if((this.$refs.selection as any).getSelection().length>1)
            {
                 ...
                 return;
                                ...
                                await this.$store.dispatch({
                                    ...
                                    stgId: (this.$refs.selection as any).getSelection()[0].archiveBoxId
                                }).then( async (response) => {
        ...
        get currentPage(){
            ...
            if(this.pagerequest.pzh == ""){
                this.pagerequest.pzh = null
             }
             if(this.pagerequest.year == ""){
                this.pagerequest.year = null
             }
