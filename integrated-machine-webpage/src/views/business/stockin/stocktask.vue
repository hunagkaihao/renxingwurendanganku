...
<template>
    <div>
        <Card dis-hover>
            <div class="page-body">
                <div class="margin-top-1">
                        <div class="main-header">
                             <nav class="navbar-default" > <h1>无人档案库操作平台-档案入库</h1> </nav>
                ...
                <div class="margin-top-10">
                    <Row>
                        <Button v-show="current<=2" icon="ios-search" type="primary" size="large" @click="taskAssign" class="toolbar-btn">{{L('下达任务')}}</Button>
                         <Button v-show="current<=2"  icon="ios-search" type="primary" size="large" @click="create" class="toolbar-btn">{{L('下达库位任务')}}</Button>
          ...
          <create-stocktask v-model="createModalShow" :mianId="currentRowId"  @save-success="getpage"></create-stocktask>
    </div>
</template>
<script lang="ts">
    ...
    import CreateStocktask from './create-stocktask.vue'
    ...
    export default class Stocktasks extends AbpBase{
        ...
        currentRowRfid:string="";
            ...
            content:'',icon:'ios-albums'},{ id:'3',title:'打开柜门',
            content:'',icon:'ios-person'},{ id:'4',title:'机械手抓取',
